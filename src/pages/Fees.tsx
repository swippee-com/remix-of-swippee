        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-8 space-y-6">
            <div className="rounded-lg border bg-card p-6 shadow-card">
              ...
              <p className="mt-2 text-sm text-muted-foreground">Our trading fee is applied per order and disclosed upfront before you confirm. Fees vary based on trade size, asset, and market conditions.</p>
